...
class SignInLoading extends MovieState {}
class SignInSuccess extends MovieState {}
class SignInError extends MovieState {
  final String errorMessage;
  SignInError(this.errorMessage);
}

class SignUpLoading extends MovieState {}
class SignUpSuccess extends MovieState {}
class SignUpError extends MovieState {
  final String errorMessage;
  SignUpError(this.errorMessage);
}


class SignInWithGoogleLoading extends MovieState {}
class SignInWithGoogleSuccess extends MovieState {}
class SignInWithGoogleError extends MovieState {
  final String errorMessage;
